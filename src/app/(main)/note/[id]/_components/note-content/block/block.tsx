    ...
    return (
      <div
        ...
        onInput={event => {
          ...
          console.log('input: ', windowSelection);
          handleInput(event, index, blockList, setBlockList, blockRef, prevChildNodesLength, setIsTyping);
        }}
        onCompositionStart={() => {
        ...
        onKeyDown={event => {
          ...
          const windowSelection = window.getSelection();
          console.log('keydown: ', windowSelection);
        }}
        onMouseUp={event => {
